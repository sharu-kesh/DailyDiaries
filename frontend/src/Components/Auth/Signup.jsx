...
import { User, Mail, Lock, ArrowRight, Eye, EyeOff } from 'lucide-react'; // Added Eye and EyeOff icons
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.formContainer}>
        <h1 style={styles.header}>Join the Bloggers Community.</h1>
        ...
        <form style={styles.form} onSubmit={handleSubmit}>
          ...
          <p style={styles.termsText}>
            ...
            <a href="/terms" style={{ color: '#1A8917', textDecoration: 'none' }}>
              Terms of Service
            </a>{' '}
            and acknowledge that our{' '}
            <a href="/privacy" style={{ color: '#1A8917', textDecoration: 'none' }}>
              Privacy Policy
            </a>{' '}
            applies to you.
          </p>
